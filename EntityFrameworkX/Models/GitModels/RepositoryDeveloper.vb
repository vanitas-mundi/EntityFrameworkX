...
Namespace Models.GitModels
	...
	Partial Public Class RepositoryDeveloper

		Inherits ModelBase(Of RepositoryDeveloper)
		Implements IModelBase(Of RepositoryDeveloper, PropertyNames, GitContext)
...
#Region " --------------->> Eigenschaften der Klasse "
		Private Shared _modelCore As ModelCore(Of RepositoryDeveloper, PropertyNames, GitContext)
...
#Region " --------------->> Konstruktor und Destruktor der Klasse "
		Shared Sub New()
			_modelCore = New ModelCore(Of RepositoryDeveloper, PropertyNames, GitContext)("git.t_repository_developer")
...
#Region " --------------->> Zugriffsmethoden der Klasse "
		...
		(Of RepositoryDeveloper, PropertyNames, GitContext).RowId
			Get
				Return _rowId
			End Get
			Set(value As Int64)
...
#Region " --------------->> Öffentliche Methoden der Klasse "
		...
		(Of RepositoryDeveloper, PropertyNames, GitContext)
			Return _modelCore
		End Function

		Private Function IModelBase_ModelCore() As ModelCore(Of RepositoryDeveloper, PropertyNames, GitContext) _
		Implements IModelBase(Of RepositoryDeveloper, PropertyNames, GitContext).ModelCore
			Return _modelCore
		End Function

		Private Function IModelBase_ModelBase() As ModelBase(Of RepositoryDeveloper) _
		Implements IModelBase(Of RepositoryDeveloper, PropertyNames, GitContext).ModelBase
			Return DirectCast(Me, ModelBase(Of RepositoryDeveloper))
		End Function
